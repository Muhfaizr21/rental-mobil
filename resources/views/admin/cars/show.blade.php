            ...
            <div class="page-header-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="page-subtitle mb-0">Informasi lengkap kendaraan {{ $car->brand }} {{ $car->model }}</p>
                    </div>
                            ...
                            <div class="info-section">
                                ...
                                <div class="info-grid">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-value">{{ $car->seat_capacity ? $car->seat_capacity . ' Kursi' : '-' }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body-custom">
                    <div class="stats-grid">
                        ...
                        <div class="stat-item">
                            ...
                            <div class="stat-content">
                                <div class="stat-number">{{ $car->bookings->where('status', 'completed')->count() }}</div>
                        ...
                        <div class="stat-item">
                            ...
                            <div class="stat-content">
                                <div class="stat-number">{{ $car->bookings->whereIn('status', ['pending', 'approved'])->count() }}</div>
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="timeline-date">{{ $car->bookings->last()->created_at->format('d M Y H:i') }}</div>
                            </div>
                        </div>
                        @endif
                    </div>
