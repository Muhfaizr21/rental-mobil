...
@section('title', 'Daftar Harga Sewa Mobil Cirebon Murah - RentGo Indonesia')
            ...
            <div class="group bg-gray-800 rounded-3xl shadow-2xl hover:shadow-amber-500/10 transition-all duration-500 overflow-hidden border border-gray-700 hover:border-amber-500/30 hover:-translate-y-2">
                ...
                <div class="relative bg-gradient-to-br from-gray-900 to-gray-700 h-56 overflow-hidden">
                    @php
                        ...
                        // Cek gambar utama - gunakan approach yang sama seperti admin
                        if ($car->image) {
                    ...
                    @if($hasImage && $imageUrl)
                        ...
                        <div class="absolute inset-0 flex items-center justify-center" style="display: none;">
                            <svg class="w-32 h-32 text-amber-400/20" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="absolute top-4 left-4 z-10">
                        <div class="bg-black/60 backdrop-blur-sm text-white px-2 py-1 rounded-full text-xs font-medium border border-white/20">
                            📸 {{ $galleryCount }} foto
                        </div>
                    </div>
                    @endif
                    ...
                    {{-- Popular Badge --}}
                    @if($loop->index < 3)
                    <div class="absolute top-4 left-4 z-10 @if($galleryCount > 1) mt-8 @endif">
