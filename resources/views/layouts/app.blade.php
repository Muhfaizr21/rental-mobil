            ...
            <div class="md:col-span-2">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div class="flex flex-col">
                        <span class="text-2xl md:text-4xl font-black tracking-tight font-montserrat">
                            <span class="bg-gradient-to-r from-amber-400 via-yellow-300 to-orange-500 bg-clip-text text-transparent">rentGo</span>
                            <span class="text-gray-500 text-lg md:text-2xl">.id</span>
                        </span>
                        <span class="text-xs md:text-sm text-amber-500 font-medium tracking-widest uppercase mt-1">Premium Rental Service</span>
                    </div>
                </div>
                ...
                <div class="flex gap-4">
                    <a href="#" class="group w-10 h-10 md:w-12 md:h-12 bg-white/5 hover:bg-gradient-to-br hover:from-pink-600 hover:to-purple-700 border border-amber-500/20 hover:border-pink-500 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-pink-500/30">
                        <svg class="w-4 h-4 md:w-5 md:h-5 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
